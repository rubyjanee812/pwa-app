...
function updateCount() {
  ...
  idbKV
    ...
    .then(() => {
      elemCountTotal.textContent =
        countIDB + countCache + countLocalStorage + countSessionStorage;
      setTimeout(() => {
        updateCount();
      }, 500);
    });
...
document
  .getElementById('buttAddSession')
  .addEventListener('click', addToSessionStorage);
...
document
  .getElementById('buttClearCaches')
  .addEventListener('click', clearCacheStorage);
document.getElementById('buttClearLocal').addEventListener('click', clearLocal);
document
  .getElementById('buttClearSession')
